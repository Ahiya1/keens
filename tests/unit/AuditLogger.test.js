...
describe('AuditLogger', () => {
    ...
    describe('logAPIRequest', () => {
        test('should log regular API request', async () => {
            ...
            expect(mockDB.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO audit_logs'), expect.arrayContaining([
    ...
    describe('getAuditLogs', () => {
        ...
        test('should reject non-admin users from accessing audit logs', async () => {
            ...
            await expect(auditLogger.getAuditLogs(regularUserId, filters)).rejects.toThrow('Admin privileges required to access audit logs');
        });
        test('should apply filters correctly', async () => {
            ...
            const queryCall = mockDB.query.mock.calls.find(call => call[0].includes('SELECT * FROM audit_logs'));
            if (queryCall) {
    ...
    describe('risk assessment methods', () => {
        test('should correctly assess request risks', () => {
            const auditLoggerInstance = auditLogger;
