...
describe("DatabaseService", () => {
    ...
    describe("initialize", () => {
        it("should handle successful initialization", async () => {
            ...
            expect(console.log).toHaveBeenCalledWith("🚀 Initializing keen database...");
            expect(console.log).toHaveBeenCalledWith("✅ keen database initialized successfully!");
        ...
        it("should handle initialization failures", async () => {
            ...
            expect(console.error).toHaveBeenCalledWith("❌ Database initialization failed:", initError);
        });
    ...
    describe("getHealthStatus", () => {
        ...
        it("should handle health check failures", async () => {
            ...
            await expect(databaseService.getHealthStatus()).rejects.toThrow("Health check failed");
        });
    });
    describe("executeRawQuery", () => {
        ...
        it("should execute raw query in test environment", async () => {
            ...
            const result = await databaseService.executeRawQuery("SELECT * FROM test", ["param"]);
        ...
        it("should throw error in non-test environment", async () => {
            ...
            await expect(databaseService.executeRawQuery("SELECT * FROM test")).rejects.toThrow("Raw query execution is only allowed in test environment");
        });
        ...
        it("should handle query execution errors in test environment", async () => {
            ...
            await expect(databaseService.executeRawQuery("SELECT * FROM test")).rejects.toThrow("Query execution failed");
        });
    });
    describe("close", () => {
    ...
    describe("environment-specific behavior", () => {
        ...
        it("should restrict raw queries in production environment", async () => {
            process.env.NODE_ENV = "production";
            await expect(databaseService.executeRawQuery("SELECT 1")).rejects.toThrow("Raw query execution is only allowed in test environment");
        });
