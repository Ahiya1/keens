...
import { AnthropicConfigManager, getKeenDefaultConfig, } from "../../src/config/AnthropicConfig";
describe("AnthropicConfigManager", () => {
    ...
    describe("Beta Headers", () => {
        ...
        test("should validate keen requirements", () => {
            ...
            expect(validation.betaHeaders).toContain("interleaved-thinking-2025-05-14");
        });
    });
    ...
    describe("Cost Calculations", () => {
        test("should calculate costs correctly for standard context", () => {
            const config = new AnthropicConfigManager();
            const costBreakdown = config.calculateRequestCost(100000, // input tokens (under 200K)
            5000, // output tokens
        ...
        test("should calculate costs correctly for extended context", () => {
            const config = new AnthropicConfigManager();
            const costBreakdown = config.calculateRequestCost(300000, // input tokens (over 200K)
            10000, // output tokens
    ...
    describe("Production Readiness", () => {
        ...
        test("should detect invalid API key format", () => {
            ...
            expect(AnthropicConfigManager.validateApiKey("sk-ant-valid-key-1234567890")).toBe(true);
        });
    });
...
//# sourceMappingURL=AnthropicConfig.test.js.map