...
describe('Authentication Middleware', () => {
  ...
  describe('createAuthMiddleware', () => {
    ...
    describe('API Key Authentication', () => {
      test('should authenticate valid API key', async () => {
        ...
        expect((req as AuthenticatedRequest).apiKeyScopes).toEqual(['profile:read', 'agents:execute']);
        expect(next).toHaveBeenCalled();
      });
  ...
  describe('requireAdmin', () => {
    let adminMiddleware: ReturnType<typeof requireAdmin>;
  ...
  describe('requireAdminPrivilege', () => {
    let privilegeMiddleware: ReturnType<typeof requireAdminPrivilege>;
    ...
    test('should allow admin user with specific privilege', () => {
      ...
      privilegeMiddleware(req as Request, res as Response, next);
  ...
  describe('requireScopes', () => {
    let scopeMiddleware: ReturnType<typeof requireScopes>;
    ...
    test('should allow user with all required scopes', () => {
      ...
      (req as AuthenticatedRequest).apiKeyScopes = [];

      scopeMiddleware(req as Request, res as Response, next);
    ...
    test('should allow API key with required scopes', () => {
      ...
      (req as AuthenticatedRequest).apiKeyScopes = ['profile:read', 'agents:execute'];
  ...
  describe('optionalAuth', () => {
    let optionalAuthMiddleware: ReturnType<typeof optionalAuth>;
  ...
  describe('shouldBypassRateLimit', () => {
    test('should return true for admin user with bypass privilege', () => {
      ...
      const result = shouldBypassRateLimit(req as Request);
